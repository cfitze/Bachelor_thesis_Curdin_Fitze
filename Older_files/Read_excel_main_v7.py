...
class PlotExcel(MainClass):
    ...
    def start_dash_plot(self, import_excel):
        ...
        self.app.layout = html.Div(children=[
            ...
            html.Div(
            children=[
                html.H1(children='Interactive Plotting', style={'textAlign': 'center', 'fontSize': '35px', 'font-family': 'Source Sans Pro'}),
                dcc.Link('Go to Subpage', href='/subpage', style={'margin-left': '20px'}), # Add the link to the subpage/ link to the subpage
                html.Div(id='subpage-info', style={'display': 'flex', 'align-items': 'center'}),  # Subpage information
            ],
        ...
        self.subpage_layout = html.Div(children=[
            ...
            dcc.Link('Go back', href='/'),  # Link to go back to the main page
        ])
    ...
    def create_plot_figure(self, data_without_datetime, datetime_column, start_date, end_date, selected_columns, color_list):
        ...
        figure = {
            ...
            'layout': go.Layout(
                ...
                legend=dict(x=0, y=1.4, bgcolor='rgba(255, 255, 255, 0.8)',  # Make the legend background opaque
