...
class PlotExcel(MainClass):
        ...
        self.app.layout = html.Div(children=[
            ...
            html.Div(
                children=[
                    ...
                    html.Div(
                        children=[
                            html.H1('Interactive Plotting', style={'textAlign': 'center','fontSize': '32px', 'fontFamily': 'Source Sans Pro'})
                        ],
    ...
    def run_server(self):
        self.app.run_server(port=8050,debug=True, dev_tools_ui=True) #dev_tools_hot_reload_interval=1000, dev_tools_silence_routes_logging=False)
        # self.app.run_server()
