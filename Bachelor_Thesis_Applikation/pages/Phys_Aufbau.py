            ...
            html.Div(
                ...
                children=[
                    ...
                    html.Div(
                        [
                            html.Button(
                                html.Span(className='fas fa-arrow-left', style={'margin-right': '5px', 'color': 'white'}),
                                id='previous-button',
                                n_clicks=0,
                                style={'display': 'inline-block', 'background-color': 'transparent'}
                            ),
                            html.Span('Standort', style={'margin-right': '20px', 'font-size': '12px', 'color': 'white'}),
                            html.Button(
                                html.Span(className='fas fa-arrow-right', style={'margin-right': '5px', 'color': 'white'}),
                                id='next-button',
                                n_clicks=0,
                                style={'display': 'inline-block', 'background-color': 'transparent'}
                            ),
                            html.Span('Aufbau', style={'font-size': '12px', 'color': 'white'})
                        ],
